...
CREATE TABLE `position` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_position_company_id_idx` (`company_id`),
  CONSTRAINT `fk_position_company_id` FOREIGN KEY (`company_id`) REFERENCES `company` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
