...
CREATE TABLE `department` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_department_company_id_idx` (`company_id`),
  CONSTRAINT `fk_department_company_id` FOREIGN KEY (`id`) REFERENCES `company` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
